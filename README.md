...
Hardy, R. (2016, 08 25). _How to convert daily volatility to monthly?_ Retrieved from stats.stackexchange.com: https://stats.stackexchange.com/q/231713

Heiner, M. (n.d.). _Bayesian Statistics: Techniques and Models._ Retrieved from Coursera.org: https://www.coursera.org/learn/mcmc-bayesian-statistics

Ricci, V. (2005, 02). _FITTING DISTRIBUTIONS WITH R._ Retrieved from https://cran.r-project.org/doc/contrib/Ricci-distributions-en.pdf
